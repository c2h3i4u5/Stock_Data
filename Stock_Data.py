...
# =============================================================================
# #https://info512.taifex.com.tw/Future/FusaQuote_Norl.aspx     日盤
# #https://info512ah.taifex.com.tw/Future/FusaQuote_Norl.aspx   夜盤
# =============================================================================
...
with open('output.csv', 'w', newline='') as csvfile:
    ...
    if (Hour_now >= 8 and Hour_now <= 13):
        r = requests.get('https://info512.taifex.com.tw/Future/FusaQuote_Norl.aspx')
    if (Hour_now >= 15 and Hour_now <= 23) or (Hour_now >= 0 and Hour_now <= 5):
        r = requests.get('https://info512ah.taifex.com.tw/Future/FusaQuote_Norl.aspx')
    if r.status_code == requests.codes.ok: 
        stock_URL = r.text
        
        Stock_state = stock_URL.find("收盤")
        if Stock_state == -1:
            ...
            writer.writerow([Buy_price,Buy_count,Sell_price,Sell_count,Final_price,Up_Down,Vibration,Final_Volume,Open_price,Highest_price,Lowest_price,Reference_price,Time_step,Time_now])
    #       print(Data_list)
            time.sleep( 3 )
...
#        get = False
    ...
    # writer.writerow([Buy_price,Buy_count,Sell_price,Sell_count,Final_price,Up_Down,Vibration,Final_Volume,Open_price,Highest_price,Lowest_price,Reference_price,Time_step])
    # print(Data_list)
#        if get == False:
#            i = False
#        return Data_list
